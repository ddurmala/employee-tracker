...
class AddSubset {
    static async showAddDeptPrompt(handleAddOptions, init) {
        ...
        await Query.addDepartment(answerObj, handleAddOptions, init);

        // handleAddOptions();
    }

    static async showAddRolePrompt(handleAddOptions, init) {
        ...
        await Query.addRole(answerObj, handleAddOptions, init);

        // handleAddOptions();
    }
    static async showAddEmployeePrompt(handleAddOptions, init) {
        ...
        await Query.addEmployee(answerObj, handleAddOptions, init);
